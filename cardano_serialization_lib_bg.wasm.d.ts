...
export function transactionbuilder_add_output_amount(a: number, b: number, c: number): void;
export function transactionbuilder_add_output_coin(a: number, b: number, c: number): void;
export function transactionbuilder_add_output_coin_and_asset(a: number, b: number, c: number, d: number): void;
export function transactionbuilder_add_output_asset_and_min_required_coin(a: number, b: number, c: number): void;
...
export function transactionbuilder_set_mint(a: number, b: number): void;
...
export function __wbg_requiredsignatureset_free(a: number): void;
export function requiredsignatureset_add_vkey(a: number, b: number): void;
export function requiredsignatureset_add_vkey_key(a: number, b: number): void;
export function requiredsignatureset_add_bootstrap(a: number, b: number): void;
export function requiredsignatureset_add_bootstrap_key(a: number, b: number): void;
export function requiredsignatureset_add_native_script(a: number, b: number): void;
export function requiredsignatureset_add_native_script_hash(a: number, b: number): void;
export function requiredsignatureset_add_plutus_script(a: number, b: number): void;
export function requiredsignatureset_add_plutus_hash(a: number, b: number): void;
export function requiredsignatureset_add_plutus_datum(a: number, b: number): void;
export function requiredsignatureset_add_plutus_datum_hash(a: number, b: number): void;
export function requiredsignatureset_add_redeemer(a: number, b: number): void;
export function requiredsignatureset_add_redeemer_tag(a: number, b: number): void;
export function requiredsignatureset_add_all(a: number, b: number): void;
export function requiredsignatureset_new(): number;
...
export function transactionwitnesssetbuilder_set_required_sigs(a: number, b: number): void;
export function transactionwitnesssetbuilder_get_required_sigs(a: number): number;
